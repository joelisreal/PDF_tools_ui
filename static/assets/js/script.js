...
//                     let toolHeader = document.querySelector('.tool-header');
...
//     // Loop through all files and append each one separately
//     for (let i = 0; i < files.length; i++) {
//         formData.append('files', files[i]); // files[i] will be an individual file
//     }
